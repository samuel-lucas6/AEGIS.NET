...
public class AEGIS256Tests
{
    ...
    {
        yield return [AEGIS256.MinTagSize, 1, AEGIS256.NonceSize, AEGIS256.KeySize, 16, AEGIS256.MinTagSize];
        yield return [AEGIS256.MinTagSize, 0, AEGIS256.NonceSize + 1, AEGIS256.KeySize, 16, AEGIS256.MinTagSize];
        yield return [AEGIS256.MinTagSize, 0, AEGIS256.NonceSize - 1, AEGIS256.KeySize, 16, AEGIS256.MinTagSize];
        yield return [AEGIS256.MinTagSize, 0, AEGIS256.NonceSize, AEGIS256.KeySize + 1, 16, AEGIS256.MinTagSize];
        yield return [AEGIS256.MinTagSize, 0, AEGIS256.NonceSize, AEGIS256.KeySize - 1, 16, AEGIS256.MinTagSize];
        yield return [AEGIS256.MaxTagSize, 0, AEGIS256.NonceSize, AEGIS256.KeySize, 16, AEGIS256.MaxTagSize + 1];
        yield return [AEGIS256.MaxTagSize, 0, AEGIS256.NonceSize, AEGIS256.KeySize, 16, AEGIS256.MaxTagSize - 1];
        yield return [AEGIS256.MinTagSize, 0, AEGIS256.NonceSize, AEGIS256.KeySize, 16, AEGIS256.MinTagSize + 1];
        yield return [AEGIS256.MinTagSize, 0, AEGIS256.NonceSize, AEGIS256.KeySize, 16, AEGIS256.MinTagSize - 1];
    }
