...
public class AEGIS128LTests
{
    ...
    {
        yield return new object[] { AEGIS128L.MinTagSize, 1, AEGIS128L.NonceSize, AEGIS128L.KeySize, 16, AEGIS128L.MinTagSize };
        yield return new object[] { AEGIS128L.MinTagSize, 0, AEGIS128L.NonceSize + 1, AEGIS128L.KeySize, 16, AEGIS128L.MinTagSize };
        yield return new object[] { AEGIS128L.MinTagSize, 0, AEGIS128L.NonceSize - 1, AEGIS128L.KeySize, 16, AEGIS128L.MinTagSize };
        yield return new object[] { AEGIS128L.MinTagSize, 0, AEGIS128L.NonceSize, AEGIS128L.KeySize + 1, 16, AEGIS128L.MinTagSize };
        yield return new object[] { AEGIS128L.MinTagSize, 0, AEGIS128L.NonceSize, AEGIS128L.KeySize - 1, 16, AEGIS128L.MinTagSize };
        yield return new object[] { AEGIS128L.MaxTagSize, 0, AEGIS128L.NonceSize, AEGIS128L.KeySize, 16, AEGIS128L.MaxTagSize + 1 };
        yield return new object[] { AEGIS128L.MaxTagSize, 0, AEGIS128L.NonceSize, AEGIS128L.KeySize, 16, AEGIS128L.MaxTagSize - 1 };
        yield return new object[] { AEGIS128L.MinTagSize, 0, AEGIS128L.NonceSize, AEGIS128L.KeySize, 16, AEGIS128L.MinTagSize + 1 };
        yield return new object[] { AEGIS128L.MinTagSize, 0, AEGIS128L.NonceSize, AEGIS128L.KeySize, 16, AEGIS128L.MinTagSize - 1 };
    }
